...
namespace fachaMotos.Migrations
{
    ...
    [Migration("20250531203224_AgregarListasYFavoritos")]
    partial class AgregarListasYFavoritos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fachaMotos.Models.Entities.ListaDeFavoritos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("fachaMotos.Models.Entities.MotoFavorita", b =>
                {
                    b.Property<int>("ListaDeFavoritosId")
                        .HasColumnType("integer");

                    b.Property<int>("MotoId")
                        .HasColumnType("integer");

                    b.HasKey("ListaDeFavoritosId", "MotoId");

                    b.HasIndex("MotoId");

                    b.ToTable("MotosFavoritas");
                });
            ...
            modelBuilder.Entity("fachaMotos.Models.Entities.MotoFavorita", b =>
                {
                    b.HasOne("fachaMotos.Models.Entities.ListaDeFavoritos", "ListaDeFavoritos")
                        .WithMany("MotosFavoritas")
                        .HasForeignKey("ListaDeFavoritosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("fachaMotos.Models.Entities.Bike", "Moto")
                        .WithMany("MotosFavoritas")
